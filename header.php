...
// Code nga mo ceck if nag exist ang id ni user
...
<div id="logoutModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex justify-center items-center">
  <div class="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-md">
    ...
    <div class="flex justify-end space-x-3">
      ...
      <a href="<?= $base ?>logout.php" class="px-4 py-2 rounded bg-red-600 hover:bg-red-700 text-black">Logout</a>
    </div>
  </div>
</div>
