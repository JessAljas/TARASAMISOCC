<?php
// Session should already be started on the main page
// Get pending QR payments count
...
?>
<body class="bg-gray-100 font-[Poppins] min-h-screen overflow-x-hidden">

<aside id="sidebar" class="bg-green-600 text-white fixed h-full w-64 flex flex-col z-40">
  <!-- HEADER -->
  ...
  <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
    <a href="agency_dashboard.php" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition">
      <i class="fas fa-home w-6 text-center"></i> <span class="font-medium">Dashboard</span>
    </a>
    <a href="agency_add_package.php" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition">
      <i class="fas fa-box-open w-6 text-center"></i> <span class="font-medium">Packages</span>
    </a>
    <a href="agency_qr_booking.php?status=pending" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition relative">
    ...
    <a href="payments.php?status=received" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition">
      <i class="fas fa-credit-card w-6 text-center"></i> <span class="font-medium">PayMongo</span>
    </a>
    <a href="agency_registered_tourist.php" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition">
      <i class="fas fa-users w-6 text-center"></i> <span class="font-medium">Tourists</span>
    </a>
    <a href="agency_add_tourist_spots.php" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition">
      <i class="fas fa-map-marker-alt w-6 text-center"></i> <span class="font-medium">Tourist Spots</span>
    </a>
    <a href="agency_registered_tourist_spots.php" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition">
      <i class="fas fa-user-tie w-6 text-center"></i> <span class="font-medium">Spot Owners</span>
    </a>
    <a href="agency_messages.php" class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-green-500 transition relative">
  ...
  <!-- LOGOUT BUTTON -->
  <div class="p-4 border-t border-green-500 mt-auto">
  ...
  <!-- LOGOUT MODAL - put this OUTSIDE main divs -->
  <div id="logoutModal"
      class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center z-[99999]">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-xs p-6 text-center relative">
